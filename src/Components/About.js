...
const About = ({selectFilter, filter}) => {
  ...
  return(
    ...
    //             <Link to='/menu'><Button basic onClick={(e) => selectFilter(1)}>PLATES</Button></Link>
    //         </Grid.Column>
    //         <Grid.Column>
    //           <Image 
    //             centered
    ...
    //             <Link to='/menu'><Button basic onClick={(e) => selectFilter(2)}>SIDES</Button></Link>
    //         </Grid.Column>
    //         <Grid.Column>
    //           <Image 
    //             centered
